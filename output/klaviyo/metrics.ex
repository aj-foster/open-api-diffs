defmodule Metrics do
  ...
  **Scopes:**
  ...
  """
  @spec get_metric(String.t(), keyword) :: {:ok, GetMetricResponse.t()} | {:error, map}
  ...
  **Scopes:**
  ...
  """
  @spec get_metrics(keyword) :: {:ok, GetMetricResponseCollection.t()} | {:error, map}
  def get_metrics(opts \\ []) do
    ...
    client.request(%{
      ...
      method: :get,
      query: query,
      response: [{200, {GetMetricResponseCollection, :t}}, {"4XX", :map}, {"5XX", :map}],
      opts: opts
    })
  end
  ...
  **Scopes:**
  ...
  @spec query_metric_aggregates(MetricAggregateQuery.t(), keyword) ::
          {:ok, PostMetricAggregateResponse.t()} | {:error, map}
  def query_metric_aggregates(body, opts \\ []) do
    ...
    client.request(%{
      ...
      response: [{200, {PostMetricAggregateResponse, :t}}, {"4XX", :map}, {"5XX", :map}],
      opts: opts
    })
  end
end
