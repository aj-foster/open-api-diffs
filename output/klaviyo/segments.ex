defmodule Segments do
  ...
  **Scopes:**
  ...
  @spec get_segment(String.t(), keyword) ::
          {:ok, GetSegmentRetrieveResponseCompoundDocument.t()} | {:error, map}
  ...
  **Scopes:**
  ...
  @spec get_segment_profiles(String.t(), keyword) ::
          {:ok, GetSegmentMemberResponseCollection.t()} | {:error, map}
  def get_segment_profiles(id, opts \\ []) do
    ...
    client.request(%{
      ...
      method: :get,
      query: query,
      response: [{200, {GetSegmentMemberResponseCollection, :t}}, {"4XX", :map}, {"5XX", :map}],
      opts: opts
    })
  end
  ...
  **Scopes:**
  ...
  @spec get_segment_relationships_profiles(String.t(), keyword) ::
          {:ok, GetSegmentRelationshipsResponseCollection.t()} | {:error, map}
  ...
  **Scopes:**
  ...
  @spec get_segment_relationships_tags(String.t(), keyword) ::
          {:ok, GetSegmentTagRelationshipListResponseCollection.t()} | {:error, map}
  ...
  **Scopes:**
  ...
  @spec get_segments(keyword) ::
          {:ok, GetSegmentListResponseCollectionCompoundDocument.t()} | {:error, map}
  ...
  **Scopes:**
  ...
  @spec update_segment(String.t(), SegmentPartialUpdateQuery.t(), keyword) ::
          {:ok, PatchSegmentPartialUpdateResponse.t()} | {:error, map}
  def update_segment(id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      response: [{200, {PatchSegmentPartialUpdateResponse, :t}}, {"4XX", :map}, {"5XX", :map}],
      opts: opts
    })
  end
end
