defmodule Templates do
  ...
  **Scopes:**
  ...
  @spec create_template(TemplateCreateQuery.t(), keyword) ::
          {:ok, PostTemplateResponse.t()} | {:error, map}
  def create_template(body, opts \\ []) do
    ...
    client.request(%{
      ...
      response: [{201, {PostTemplateResponse, :t}}, {"4XX", :map}, {"5XX", :map}],
      opts: opts
    })
  end
  ...
  **Scopes:**
  `templates:write`
  """
  @spec delete_template(String.t(), keyword) :: :ok | {:error, map}
  ...
  **Scopes:**
  ...
  """
  @spec get_template(String.t(), keyword) :: {:ok, GetTemplateResponse.t()} | {:error, map}
  ...
  **Scopes:**
  ...
  """
  @spec get_templates(keyword) :: {:ok, GetTemplateResponseCollection.t()} | {:error, map}
  def get_templates(opts \\ []) do
    ...
    client.request(%{
      ...
      method: :get,
      query: query,
      response: [{200, {GetTemplateResponseCollection, :t}}, {"4XX", :map}, {"5XX", :map}],
      opts: opts
    })
  end
  ...
  **Scopes:**
  ...
  @spec update_template(String.t(), TemplateUpdateQuery.t(), keyword) ::
          {:ok, PatchTemplateResponse.t()} | {:error, map}
  def update_template(id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      response: [{200, {PatchTemplateResponse, :t}}, {"4XX", :map}, {"5XX", :map}],
      opts: opts
    })
  end
end
