defmodule Tags do
  ...
  **Scopes:**
  ...
  `tags:write`
  """
  @spec create_tag(TagCreateQuery.t(), keyword) :: {:ok, PostTagResponse.t()} | {:error, map}
  def create_tag(body, opts \\ []) do
    ...
    client.request(%{
      ...
      response: [{201, {PostTagResponse, :t}}, {"4XX", :map}, {"5XX", :map}],
      opts: opts
    })
  end
  ...
  **Scopes:**
  ...
  @spec create_tag_group(TagGroupCreateQuery.t(), keyword) ::
          {:ok, PostTagGroupResponse.t()} | {:error, map}
  def create_tag_group(body, opts \\ []) do
    ...
    client.request(%{
      ...
      response: [{201, {PostTagGroupResponse, :t}}, {"4XX", :map}, {"5XX", :map}],
      opts: opts
    })
  end
  ...
  **Scopes:**
  ...
  `tags:write`
  """
  @spec create_tag_relationships_flows(String.t(), TagFlowOp.t(), keyword) :: :ok | {:error, map}
  ...
  **Scopes:**
  ...
  `tags:write`
  """
  @spec create_tag_relationships_lists(String.t(), TagListOp.t(), keyword) :: :ok | {:error, map}
  ...
  **Scopes:**
  ...
  `tags:write`
  """
  @spec delete_tag(String.t(), keyword) :: :ok | {:error, map}
  ...
  **Scopes:**
  ...
  `tags:write`
  """
  @spec delete_tag_group(String.t(), keyword) :: {:ok, DeleteTagGroupResponse.t()} | {:error, map}
  def delete_tag_group(id, opts \\ []) do
    ...
    client.request(%{
      ...
      method: :delete,
      response: [{200, {DeleteTagGroupResponse, :t}}, {"4XX", :map}, {"5XX", :map}],
      opts: opts
    })
  end
  ...
  **Scopes:**
  ...
  `tags:write`
  """
  @spec delete_tag_relationships_flows(String.t(), TagFlowOp.t(), keyword) :: :ok | {:error, map}
  ...
  **Scopes:**
  ...
  `tags:write`
  """
  @spec delete_tag_relationships_lists(String.t(), TagListOp.t(), keyword) :: :ok | {:error, map}
  ...
  **Scopes:**
  ...
  """
  @spec get_tag(String.t(), keyword) :: {:ok, GetTagResponseCompoundDocument.t()} | {:error, map}
  def get_tag(id, opts \\ []) do
    ...
    client.request(%{
      ...
      method: :get,
      query: query,
      response: [{200, {GetTagResponseCompoundDocument, :t}}, {"4XX", :map}, {"5XX", :map}],
      opts: opts
    })
  end
  ...
  **Scopes:**
  ...
  """
  @spec get_tag_group(String.t(), keyword) :: {:ok, GetTagGroupResponse.t()} | {:error, map}
  def get_tag_group(id, opts \\ []) do
    ...
    client.request(%{
      ...
      method: :get,
      query: query,
      response: [{200, {GetTagGroupResponse, :t}}, {"4XX", :map}, {"5XX", :map}],
      opts: opts
    })
  end
  ...
  **Scopes:**
  ...
  @spec get_tag_group_relationships_tags(String.t(), keyword) ::
          {:ok, GetTagGroupTagRelationshipsResponseCollection.t()} | {:error, map}
  ...
  **Scopes:**
  ...
  @spec get_tag_group_tags(String.t(), keyword) ::
          {:ok, GetTagResponseCollection.t()} | {:error, map}
  def get_tag_group_tags(id, opts \\ []) do
    ...
    client.request(%{
      ...
      method: :get,
      query: query,
      response: [{200, {GetTagResponseCollection, :t}}, {"4XX", :map}, {"5XX", :map}],
      opts: opts
    })
  end
  ...
  **Scopes:**
  ...
  """
  @spec get_tag_groups(keyword) :: {:ok, GetTagGroupResponseCollection.t()} | {:error, map}
  def get_tag_groups(opts \\ []) do
    ...
    client.request(%{
      ...
      method: :get,
      query: query,
      response: [{200, {GetTagGroupResponseCollection, :t}}, {"4XX", :map}, {"5XX", :map}],
      opts: opts
    })
  end
  ...
  **Scopes:**
  ...
  @spec get_tag_relationships_campaigns(String.t(), keyword) ::
          {:ok, GetTagCampaignRelationshipsResponseCollection.t()} | {:error, map}
  ...
  **Scopes:**
  ...
  @spec get_tag_relationships_flows(String.t(), keyword) ::
          {:ok, GetTagFlowRelationshipsResponseCollection.t()} | {:error, map}
  ...
  **Scopes:**
  ...
  @spec get_tag_relationships_lists(String.t(), keyword) ::
          {:ok, GetTagListRelationshipsResponseCollection.t()} | {:error, map}
  ...
  **Scopes:**
  ...
  @spec get_tag_relationships_segments(String.t(), keyword) ::
          {:ok, GetTagSegmentRelationshipsResponseCollection.t()} | {:error, map}
  ...
  **Scopes:**
  ...
  @spec get_tag_relationships_tag_group(String.t(), keyword) ::
          {:ok, GetTagTagGroupRelationshipsResponse.t()} | {:error, map}
  def get_tag_relationships_tag_group(id, opts \\ []) do
    ...
    client.request(%{
      ...
      method: :get,
      response: [{200, {GetTagTagGroupRelationshipsResponse, :t}}, {"4XX", :map}, {"5XX", :map}],
      opts: opts
    })
  end
  ...
  **Scopes:**
  ...
  """
  @spec get_tag_tag_group(String.t(), keyword) :: {:ok, GetTagGroupResponse.t()} | {:error, map}
  ...
  **Scopes:**
  ...
  """
  @spec get_tags(keyword) :: {:ok, GetTagResponseCollectionCompoundDocument.t()} | {:error, map}
  ...
  **Scopes:**
  ...
  `tags:write`
  """
  @spec update_tag(String.t(), TagUpdateQuery.t(), keyword) :: :ok | {:error, map}
  ...
  **Scopes:**
  ...
  @spec update_tag_group(String.t(), TagGroupUpdateQuery.t(), keyword) ::
          {:ok, PatchTagGroupResponse.t()} | {:error, map}
  def update_tag_group(id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      response: [{200, {PatchTagGroupResponse, :t}}, {"4XX", :map}, {"5XX", :map}],
      opts: opts
    })
  end
end
