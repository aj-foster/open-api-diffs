defmodule Lists do
  ...
  **Scopes:**
  ...
  @spec create_list(ListCreateQuery.t(), keyword) ::
          {:ok, PostListCreateResponse.t()} | {:error, map}
  def create_list(body, opts \\ []) do
    ...
    client.request(%{
      ...
      response: [{201, {PostListCreateResponse, :t}}, {"4XX", :map}, {"5XX", :map}],
      opts: opts
    })
  end
  ...
  **Scopes:**
  `lists:write`
  """
  @spec delete_list(String.t(), keyword) :: :ok | {:error, map}
  ...
  **Scopes:**
  ...
  @spec get_list(String.t(), keyword) ::
          {:ok, GetListRetrieveResponseCompoundDocument.t()} | {:error, map}
  ...
  **Scopes:**
  ...
  @spec get_list_profiles(String.t(), keyword) ::
          {:ok, GetListMemberResponseCollection.t()} | {:error, map}
  def get_list_profiles(id, opts \\ []) do
    ...
    client.request(%{
      ...
      method: :get,
      query: query,
      response: [{200, {GetListMemberResponseCollection, :t}}, {"4XX", :map}, {"5XX", :map}],
      opts: opts
    })
  end
  ...
  **Scopes:**
  ...
  @spec get_list_relationships_profiles(String.t(), keyword) ::
          {:ok, GetListRelationshipsResponseCollection.t()} | {:error, map}
  ...
  **Scopes:**
  ...
  @spec get_list_relationships_tags(String.t(), keyword) ::
          {:ok, GetListTagRelationshipListResponseCollection.t()} | {:error, map}
  ...
  **Scopes:**
  ...
  """
  @spec get_list_tags(String.t(), keyword) :: {:ok, GetTagResponseCollection.t()} | {:error, map}
  ...
  **Scopes:**
  ...
  @spec get_lists(keyword) ::
          {:ok, GetListListResponseCollectionCompoundDocument.t()} | {:error, map}
  ...
  **Scopes:**
  ...
  @spec update_list(String.t(), ListPartialUpdateQuery.t(), keyword) ::
          {:ok, PatchListPartialUpdateResponse.t()} | {:error, map}
  def update_list(id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      response: [{200, {PatchListPartialUpdateResponse, :t}}, {"4XX", :map}, {"5XX", :map}],
      opts: opts
    })
  end
end
