defmodule Coupons do
  ...
  **Scopes:**
  ...
  @spec create_coupon(CouponCreateQuery.t(), keyword) ::
          {:ok, PostCouponResponse.t()} | {:error, map}
  def create_coupon(body, opts \\ []) do
    ...
    client.request(%{
      ...
      response: [{201, {PostCouponResponse, :t}}, {"4XX", :map}, {"5XX", :map}],
      opts: opts
    })
  end
  ...
  **Scopes:**
  ...
  @spec create_coupon_code(CouponCodeCreateQuery.t(), keyword) ::
          {:ok, PostCouponCodeResponse.t()} | {:error, map}
  def create_coupon_code(body, opts \\ []) do
    ...
    client.request(%{
      ...
      response: [{201, {PostCouponCodeResponse, :t}}, {"4XX", :map}, {"5XX", :map}],
      opts: opts
    })
  end
  ...
  **Scopes:**
  `coupons:write`
  """
  @spec delete_coupon(String.t(), keyword) :: :ok | {:error, map}
  ...
  **Scopes:**
  `coupon-codes:write`
  """
  @spec delete_coupon_code(String.t(), keyword) :: :ok | {:error, map}
  ...
  **Scopes:**
  ...
  """
  @spec get_coupon(String.t(), keyword) :: {:ok, GetCouponResponse.t()} | {:error, map}
  def get_coupon(id, opts \\ []) do
    ...
    client.request(%{
      ...
      method: :get,
      query: query,
      response: [{200, {GetCouponResponse, :t}}, {"4XX", :map}, {"5XX", :map}],
      opts: opts
    })
  end
  ...
  **Scopes:**
  ...
  @spec get_coupon_code(String.t(), keyword) ::
          {:ok, GetCouponCodeResponseCompoundDocument.t()} | {:error, map}
  def get_coupon_code(id, opts \\ []) do
    ...
    client.request(%{
      ...
      method: :get,
      query: query,
      response: [{200, {GetCouponCodeResponseCompoundDocument, :t}}, {"4XX", :map}, {"5XX", :map}],
      opts: opts
    })
  end
  ...
  **Scopes:**
  ...
  @spec get_coupon_code_bulk_create_job(String.t(), keyword) ::
          {:ok, GetCouponCodeCreateJobResponseCompoundDocument.t()} | {:error, map}
  ...
  **Scopes:**
  ...
  @spec get_coupon_code_bulk_create_jobs(keyword) ::
          {:ok, GetCouponCodeCreateJobResponseCollectionCompoundDocument.t()} | {:error, map}
  ...
  **Scopes:**
  ...
  @spec get_coupon_code_relationships_coupon(String.t(), keyword) ::
          {:ok, GetCouponRelationshipCouponCodesListResponseCollection.t()} | {:error, map}
  ...
  **Scopes:**
  ...
  @spec get_coupon_codes(keyword) ::
          {:ok, GetCouponCodeResponseCollectionCompoundDocument.t()} | {:error, map}
  ...
  **Scopes:**
  ...
  @spec get_coupon_codes_for_coupon(String.t(), keyword) ::
          {:ok, GetCouponCodeResponseCollection.t()} | {:error, map}
  def get_coupon_codes_for_coupon(id, opts \\ []) do
    ...
    client.request(%{
      ...
      method: :get,
      query: query,
      response: [{200, {GetCouponCodeResponseCollection, :t}}, {"4XX", :map}, {"5XX", :map}],
      opts: opts
    })
  end
  ...
  **Scopes:**
  ...
  @spec get_coupon_for_coupon_code(String.t(), keyword) ::
          {:ok, GetCouponResponseCollection.t()} | {:error, map}
  def get_coupon_for_coupon_code(id, opts \\ []) do
    ...
    client.request(%{
      ...
      method: :get,
      query: query,
      response: [{200, {GetCouponResponseCollection, :t}}, {"4XX", :map}, {"5XX", :map}],
      opts: opts
    })
  end
  ...
  **Scopes:**
  ...
  @spec get_coupon_relationships_coupon_codes(String.t(), keyword) ::
          {:ok, GetCouponCodeRelationshipCouponResponse.t()} | {:error, map}
  ...
  **Scopes:**
  ...
  """
  @spec get_coupons(keyword) :: {:ok, GetCouponResponseCollection.t()} | {:error, map}
  ...
  **Scopes:**
  ...
  @spec spawn_coupon_code_bulk_create_job(CouponCodeCreateJobCreateQuery.t(), keyword) ::
          {:ok, PostCouponCodeCreateJobResponse.t()} | {:error, map}
  def spawn_coupon_code_bulk_create_job(body, opts \\ []) do
    ...
    client.request(%{
      ...
      response: [{202, {PostCouponCodeCreateJobResponse, :t}}, {"4XX", :map}, {"5XX", :map}],
      opts: opts
    })
  end
  ...
  **Scopes:**
  ...
  @spec update_coupon(String.t(), CouponUpdateQuery.t(), keyword) ::
          {:ok, PatchCouponResponse.t()} | {:error, map}
  def update_coupon(id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      response: [{200, {PatchCouponResponse, :t}}, {"4XX", :map}, {"5XX", :map}],
      opts: opts
    })
  end
  ...
  **Scopes:**
  ...
  @spec update_coupon_code(String.t(), CouponCodeUpdateQuery.t(), keyword) ::
          {:ok, PatchCouponCodeResponse.t()} | {:error, map}
  def update_coupon_code(id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      response: [{200, {PatchCouponCodeResponse, :t}}, {"4XX", :map}, {"5XX", :map}],
      opts: opts
    })
  end
end
