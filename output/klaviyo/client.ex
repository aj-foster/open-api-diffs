defmodule Client do
  ...
  **Scopes:**
  ...
  """
  @spec bulk_create_client_events(EventsBulkCreateQuery.t(), keyword) :: :ok | {:error, map}
  ...
  **Scopes:**
  ...
  """
  @spec create_client_event(EventCreateQueryV2.t(), keyword) :: :ok | {:error, map}
  ...
  **Scopes:**
  ...
  """
  @spec create_client_profile(OnsiteProfileCreateQuery.t(), keyword) :: :ok | {:error, map}
  ...
  """
  @spec create_client_push_token(PushTokenCreateQuery.t(), keyword) :: :ok | {:error, map}
  ...
  **Scopes:**
  ...
  """
  @spec unregister_client_push_token(PushTokenUnregisterQuery.t(), keyword) :: :ok | {:error, map}
