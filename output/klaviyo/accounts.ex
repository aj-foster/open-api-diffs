defmodule Accounts do
  ...
  **Scopes:**
  ...
  """
  @spec get_account(String.t(), keyword) :: {:ok, GetAccountResponse.t()} | {:error, map}
  def get_account(id, opts \\ []) do
    ...
    client.request(%{
      ...
      method: :get,
      query: query,
      response: [{200, {GetAccountResponse, :t}}, {"4XX", :map}, {"5XX", :map}],
      opts: opts
    })
  end
  ...
  **Scopes:**
  ...
  """
  @spec get_accounts(keyword) :: {:ok, GetAccountResponseCollection.t()} | {:error, map}
  def get_accounts(opts \\ []) do
    ...
    client.request(%{
      ...
      method: :get,
      query: query,
      response: [{200, {GetAccountResponseCollection, :t}}, {"4XX", :map}, {"5XX", :map}],
      opts: opts
    })
  end
end
