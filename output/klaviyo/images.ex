defmodule Images do
  ...
  **Scopes:**
  ...
  """
  @spec get_image(String.t(), keyword) :: {:ok, GetImageResponse.t()} | {:error, map}
  def get_image(id, opts \\ []) do
    ...
    client.request(%{
      ...
      method: :get,
      query: query,
      response: [{200, {GetImageResponse, :t}}, {"4XX", :map}, {"5XX", :map}],
      opts: opts
    })
  end
  ...
  **Scopes:**
  ...
  """
  @spec get_images(keyword) :: {:ok, GetImageResponseCollection.t()} | {:error, map}
  def get_images(opts \\ []) do
    ...
    client.request(%{
      ...
      method: :get,
      query: query,
      response: [{200, {GetImageResponseCollection, :t}}, {"4XX", :map}, {"5XX", :map}],
      opts: opts
    })
  end
  ...
  **Scopes:**
  ...
  @spec update_image(String.t(), ImagePartialUpdateQuery.t(), keyword) ::
          {:ok, PatchImageResponse.t()} | {:error, map}
  def update_image(id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      response: [{200, {PatchImageResponse, :t}}, {"4XX", :map}, {"5XX", :map}],
      opts: opts
    })
  end
  ...
  **Scopes:**
  ...
  @spec upload_image_from_file(ImageUploadQuery.t(), keyword) ::
          {:ok, PostImageResponse.t()} | {:error, map}
  def upload_image_from_file(body, opts \\ []) do
    ...
    client.request(%{
      ...
      response: [{201, {PostImageResponse, :t}}, {"4XX", :map}, {"5XX", :map}],
      opts: opts
    })
  end
