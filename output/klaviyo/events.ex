defmodule Events do
  ...
  **Scopes:**
  `events:write`
  """
  @spec create_event(EventCreateQueryV2.t(), keyword) :: :ok | {:error, map}
  ...
  **Scopes:**
  ...
  @spec get_event(String.t(), keyword) ::
          {:ok, GetEventResponseCompoundDocument.t()} | {:error, map}
  def get_event(id, opts \\ []) do
    ...
    client.request(%{
      ...
      method: :get,
      query: query,
      response: [{200, {GetEventResponseCompoundDocument, :t}}, {"4XX", :map}, {"5XX", :map}],
      opts: opts
    })
  end
  ...
  **Scopes:**
  ...
  """
  @spec get_event_metric(String.t(), keyword) :: {:ok, GetMetricResponse.t()} | {:error, map}
  def get_event_metric(id, opts \\ []) do
    ...
    client.request(%{
      ...
      method: :get,
      query: query,
      response: [{200, {GetMetricResponse, :t}}, {"4XX", :map}, {"5XX", :map}],
      opts: opts
    })
  end
  ...
  **Scopes:**
  ...
  """
  @spec get_event_profile(String.t(), keyword) :: {:ok, GetProfileResponse.t()} | {:error, map}
  def get_event_profile(id, opts \\ []) do
    ...
    client.request(%{
      ...
      method: :get,
      query: query,
      response: [{200, {GetProfileResponse, :t}}, {"4XX", :map}, {"5XX", :map}],
      opts: opts
    })
  end
  ...
  **Scopes:**
  ...
  @spec get_event_relationships_metric(String.t(), keyword) ::
          {:ok, GetEventMetricsRelationshipListResponse.t()} | {:error, map}
  ...
  **Scopes:**
  ...
  @spec get_event_relationships_profile(String.t(), keyword) ::
          {:ok, GetEventProfilesRelationshipListResponse.t()} | {:error, map}
  ...
  **Scopes:**
  ...
  @spec get_events(keyword) ::
          {:ok, GetEventResponseCollectionCompoundDocument.t()} | {:error, map}
